...
public class ChatController {
    ...
    public void chat(@DestinationVariable Integer uiNum, MessageInfoVO message, @AuthenticationPrincipal UserInfoVO user) {
        simpMessagingTemplate.convertAndSend("/queue/chat/" + uiNum, message);
    }
